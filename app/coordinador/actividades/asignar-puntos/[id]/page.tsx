...
const CoordinatorAssign = () => {
  ...
  useEffect(() => {
    ...
    if (cachedActivity) {
      console.log("Usando datos en caché (memoria)");
      setActivitySelected(cachedActivity);
      setActivity(cachedActivity);
    } else {
      console.log("Datos no encontrados, buscando en API...");
  ...
  const handleAssignPoints = async () => {
    if (selectedStudent === null) {
      ...
      await assignPointsToStudents(
        selectedActivity!.puntos_participacion,
        new Date(),
        47,
        1
      );
                  ...
                  <div>
                    ...
                    <CardDescription>
                      ...
                      <span className="font-semibold text-primary">
                        {selectedActivity.puntos_participacion} puntos
                      </span>
                    </CardDescription>
                  </div>
